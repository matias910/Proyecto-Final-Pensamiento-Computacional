...
public class ConsolaAdoptar implements ActionListener {
    ...
    JFrame VentanaAdoptar = new JFrame();
    JButton GuardarBoton = new JButton("<html>Guardar<br>Adopcion</html>");
    ...
    public ConsolaAdoptar() {
        ...
        VentanaAdoptar.setVisible(true);
        VentanaAdoptar.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        VentanaAdoptar.getContentPane().setBackground(new Color(211, 211, 211));
        VentanaAdoptar.setSize(600, 750);
        VentanaAdoptar.setResizable(false);
        VentanaAdoptar.setLayout(null);

        VentanaAdoptar.add(TextoInicioRegistro);
        VentanaAdoptar.add(TextoAnimal);
        VentanaAdoptar.add(Animal);
        VentanaAdoptar.add(GuardarBoton);
        VentanaAdoptar.add(TextoNombre);
        VentanaAdoptar.add(Nombre);
        VentanaAdoptar.add(TextoEspecie);
        VentanaAdoptar.add(Especie);
        VentanaAdoptar.add(TextoSexo);
        VentanaAdoptar.add(Masculino);
        VentanaAdoptar.add(Femenino);
        VentanaAdoptar.add(TextoRaza);
        VentanaAdoptar.add(Raza);
        VentanaAdoptar.add(TextoEstadoSalud);
        VentanaAdoptar.add(EstadoSalud);
        VentanaAdoptar.add(TextoEdad);
        VentanaAdoptar.add(Edad);
        VentanaAdoptar.add(TextoVacunado);
        VentanaAdoptar.add(SiVacunado);
        VentanaAdoptar.add(NoVacunado);
        VentanaAdoptar.add(TextoFecha);
        VentanaAdoptar.add(Fecha);
        VentanaAdoptar.add(TextoNivelAdiestramiento);
        VentanaAdoptar.add(NivelAdiestramiento);
        VentanaAdoptar.add(TextoColorPelo);
        VentanaAdoptar.add(ColorPelo);
        VentanaAdoptar.add(TextoTamano);
        VentanaAdoptar.add(Tamano);
        VentanaAdoptar.add(TextoTipoDieta);
        VentanaAdoptar.add(TipoDieta);
        VentanaAdoptar.add(TextoNivelAgresividad);
        VentanaAdoptar.add(NivelAgresividad);
        VentanaAdoptar.add(TextoEstaEsterilizado);
        VentanaAdoptar.add(SiEsterelizado);
        VentanaAdoptar.add(NoEsterelizado);
        VentanaAdoptar.add(TextoColorPlumas);
        VentanaAdoptar.add(ColorPlumas);
        VentanaAdoptar.add(TextoPuedeVolar);
        VentanaAdoptar.add(SiVuela);
        VentanaAdoptar.add(NoVuela);
        VentanaAdoptar.add(TextoFrecuenciaAlimentacion);
        VentanaAdoptar.add(FrecuenciaAlimentacion);
        VentanaAdoptar.add(TextoEsVenenosa);
        VentanaAdoptar.add(SiVenenosa);
        VentanaAdoptar.add(NoVenenosa);
        VentanaAdoptar.add(TextoTamanoCaparazon);
        VentanaAdoptar.add(TamanoCaparazon);
        VentanaAdoptar.add(TextoDietaPrincipal);
        VentanaAdoptar.add(DietaPrincipal);
        VentanaAdoptar.add(VolverMenu);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == GuardarBoton) {
            ...
            contenido.append("Adopción registrada exitosamente el" + Fecha.getText() + "\n");
            contenido.append("Adoptaste exitosamente a " + Nombre.getText() + " el " + Fecha.getText() + "\n");
            contenido.append("Adoptaste un " + Especie.getText() + " " + Raza.getText() + "\n");
            ...
            if (Animal.getSelectedIndex() == 0) {
                ...
                animalAgregar.registrarAdopcion(loro.getNombre(), loro.getFecha());
            }
            // CONEJO
            if (Animal.getSelectedIndex() == 1) {
                ...
                conejo.setEstadoDisponibilidad("Adoptado");
                ...
                animalAgregar.registrarAdopcion(conejo.getNombre(), conejo.getFecha());
            }
            // GATO
            if (Animal.getSelectedIndex() == 2) {
                ...
                gato.setEstadoDisponibilidad("Adoptado");
                ...
                animalAgregar.registrarAdopcion(gato.getNombre(), gato.getFecha());
            }
            // PERRO//
            if (Animal.getSelectedIndex() == 3) {
                ...
                animalAgregar.registrarAdopcion(perro.getNombre(), perro.getFecha());
            }
            // HAMSTER
            if (Animal.getSelectedIndex() == 4) {
                ...
                hamster.setEstadoDisponibilidad("Adoptado");
                ...
                animalAgregar.registrarAdopcion(hamster.getNombre(), hamster.getFecha());
            ...
            if (Animal.getSelectedIndex() == 5) {
                ...
                serpiente.setEstadoDisponibilidad("Adoptado");
                ...
                animalAgregar.registrarAdopcion(serpiente.getNombre(), serpiente.getFecha());
            }
            // TORTUGA
            if (Animal.getSelectedIndex() == 6) {
                ...
                tortuga.setEstadoDisponibilidad("Adoptado");
                ...
                animalAgregar.registrarAdopcion(tortuga.getNombre(), tortuga.getFecha());
            }

            String rutaArchivo = "C:\\Users\\matia\\OneDrive\\Documents\\Universidad\\Pensamiento Computacional\\Entrega Proyecto\\Recibos\\Adopcion_"
                    + Nombre.getText() + ".txt";
